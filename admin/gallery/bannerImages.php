        ...
        <div class="table-responsive">
            <table class="table data-table">
                ...
                <tbody>
                    <?php
                    $sl = 1;
                    $items = $db->select('ai_images', [], false)->result();
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="<?= admin_url('gallery/editBannerImage.php?id=' . $item->id); ?>" class="btn btn-xs btn-primary">Edit</a>
                                    <a href="<?= admin_url('gallery/bannerImages.php?action=decline&id=' . $item->id); ?>" class="btn btn-xs btn-danger btn-confirm" data-msg="Are you sure to Delete?">Delete</a>
                                </div>
                            </td>
                        </tr>
                    <?php
