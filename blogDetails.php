...
$items = $db->select('ai_blog_post', ['id' => $id, 'status' => 1], 1)->row();
$cat = $db->select('ai_blog_categories', ['id' => $items->category, 'status' => 1], 1)->row();
$userOb = new User();
$title = $items->ptitle;
$description = $items->small_desc;
$seoKeyword = $userOb->extractKeywordsFromFeatures($items->description);
include "nav.php";
?>
<section>
            ...
            <div class="col-sm-6">
                <div class="product-content">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="p-1 mt-2 border border-2">
