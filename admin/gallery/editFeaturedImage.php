...
if (isset($_POST['submit'])) {
    ...
    $db->update('ai_media', $form, ['id' => $id], 1);

    session()->set_flashdata('success', 'banner Updated Successfully ');
}
$image = $db->select('ai_media', ['id' => $id], 1)->row();
$menu = "gallery";
...
<div class="page-header">
    ...
    <div>
        <a href="<?= admin_url('gallery/addBannerImage.php') ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-circle"></i> Add New Image</a>
    </div>
</div>
    ...
    <div class="card card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                ...
                <a href="<?= admin_url('gallery/editFeaturedImage.php?id=') . $id; ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </div>
</form>
