...
if (isset($_POST['submit'])) {
    ...
    $db->update('ai_gallery_img', $form, ['id' => $id], 1);

    session()->set_flashdata('success', 'banner Updated Successfully ');
}
$image = $db->select('ai_gallery_img', ['id' => $id], 1)->row();
$menu = "gallery";
    ...
    <div class="card card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                ...
                <p class="text-danger">*Image Size will be 1200x350</p>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                ...
                <a href="<?= admin_url('gallery/editGalleryImage.php?id=') . $id; ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </div>
</form>
