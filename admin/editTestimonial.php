...
if (isset($_POST['submit'])) {
    ...
    $db->update('ai_review', $form, ['id' => $id]);

    session()->set_flashdata('success', 'Record saved successfully ');
}
$item = $db->select("ai_review", ['id' => $id], 1)->row();
...
<form enctype="multipart/form-data" action="" method="post">
    <div class="card card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" name="form[name]" value="<?= $item->name; ?>" class="form-control">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <textarea name="form[message]" class="form-control" id="" rows="6"><?= $item->message; ?></textarea>
            </div>
        </div>
