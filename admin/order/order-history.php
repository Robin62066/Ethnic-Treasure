...
if ($action == 'delete') {
    $db->delete('ai_order_enquiry', ['id' => $id]);
    session()->set_flashdata('danger', 'Order Cancle Successfull');
}
if ($action == 'confirm') {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="<?= admin_url('order/new-order.php?action=decline&id=' . $item->id); ?>" class="btn btn-xs btn-warning btn-confirm" data-msg="Are you sure to Reject?">Reject</a>
                                    <a href="<?= admin_url('order/order-history.php?action=delete&id=' . $item->id); ?>" class="btn btn-xs btn-danger btn-confirm" data-msg="Are you sure to Delete?">Delete</a>
                                </div>
                            </td>
                        </tr>
                    <?php
