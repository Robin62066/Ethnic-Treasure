            ...
            <table class="table data-table">
                ...
                <tbody>
                    ...
                    foreach ($items as $item) {
                        $parent = $db->select('ai_categories', ["id" => $item->parent_id], 1)->row();
                    ?>
                        <tr>
                            <td><?= $sl++; ?></td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="<?= admin_url('catalog/editCategories.php?id=' . $item->id); ?>" class="btn btn-xs btn-primary">Edit</a>
                                    <a href="<?= admin_url('catalog/categories.php?action=decline&id=' . $item->id); ?>" class="btn btn-xs btn-danger btn-confirm" data-msg="Are you sure to Delete?">Delete</a>
                                </div>
                            </td>
                        </tr>
                    <?php
